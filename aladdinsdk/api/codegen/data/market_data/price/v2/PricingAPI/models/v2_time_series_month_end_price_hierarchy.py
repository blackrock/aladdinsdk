...
class V2TimeSeriesMonthEndPriceHierarchy(BaseModel):
    """
    V2TimeSeriesMonthEndPriceHierarchy
    """
    ...
    __properties = ["timeSeriesAssetPrice", "assetPriceGroup"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2TimeSeriesMonthEndPriceHierarchy:
        """Create an instance of V2TimeSeriesMonthEndPriceHierarchy from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2TimeSeriesMonthEndPriceHierarchy:
        """Create an instance of V2TimeSeriesMonthEndPriceHierarchy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2TimeSeriesMonthEndPriceHierarchy.parse_obj(obj)

        _obj = V2TimeSeriesMonthEndPriceHierarchy.parse_obj({
