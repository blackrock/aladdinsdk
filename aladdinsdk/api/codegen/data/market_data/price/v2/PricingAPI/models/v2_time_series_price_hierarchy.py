...
class V2TimeSeriesPriceHierarchy(BaseModel):
    """
    V2TimeSeriesPriceHierarchy
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2TimeSeriesPriceHierarchy:
        """Create an instance of V2TimeSeriesPriceHierarchy from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2TimeSeriesPriceHierarchy:
        """Create an instance of V2TimeSeriesPriceHierarchy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2TimeSeriesPriceHierarchy.parse_obj(obj)

        _obj = V2TimeSeriesPriceHierarchy.parse_obj({
