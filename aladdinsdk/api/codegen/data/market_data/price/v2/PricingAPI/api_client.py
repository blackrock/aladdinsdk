...
import aladdinsdk.api.codegen.data.market_data.price.v2.PricingAPI.models
from aladdinsdk.api.codegen.data.market_data.price.v2.PricingAPI import rest
from aladdinsdk.api.codegen.data.market_data.price.v2.PricingAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.data.market_data.price.v2.PricingAPI.models, klass)
