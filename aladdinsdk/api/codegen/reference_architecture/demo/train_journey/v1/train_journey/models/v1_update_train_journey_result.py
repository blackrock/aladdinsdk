...
class V1UpdateTrainJourneyResult(BaseModel):
    """
    The Result body of the BatchUpdateTrainJourneys call.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateTrainJourneyResult:
        """Create an instance of V1UpdateTrainJourneyResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateTrainJourneyResult:
        """Create an instance of V1UpdateTrainJourneyResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateTrainJourneyResult.parse_obj(obj)

        _obj = V1UpdateTrainJourneyResult.parse_obj({
