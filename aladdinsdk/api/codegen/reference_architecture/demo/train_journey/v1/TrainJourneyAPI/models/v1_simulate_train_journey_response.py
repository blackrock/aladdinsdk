...
class V1SimulateTrainJourneyResponse(BaseModel):
    """
    V1SimulateTrainJourneyResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SimulateTrainJourneyResponse:
        """Create an instance of V1SimulateTrainJourneyResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SimulateTrainJourneyResponse:
        """Create an instance of V1SimulateTrainJourneyResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1SimulateTrainJourneyResponse.parse_obj(obj)

        _obj = V1SimulateTrainJourneyResponse.parse_obj({
