...
class V1ListTrainJourneysResponse(BaseModel):
    """
    V1ListTrainJourneysResponse
    """
    train_journeys: Optional[conlist(V1TrainJourney)] = Field(None, alias="trainJourneys", description="The train journeys to be returned.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ListTrainJourneysResponse:
        """Create an instance of V1ListTrainJourneysResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ListTrainJourneysResponse:
        """Create an instance of V1ListTrainJourneysResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ListTrainJourneysResponse.parse_obj(obj)

        _obj = V1ListTrainJourneysResponse.parse_obj({
