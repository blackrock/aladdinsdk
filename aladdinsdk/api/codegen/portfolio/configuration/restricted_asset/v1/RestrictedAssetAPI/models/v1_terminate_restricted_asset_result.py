...
class V1TerminateRestrictedAssetResult(BaseModel):
    """
    V1TerminateRestrictedAssetResult
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1TerminateRestrictedAssetResult:
        """Create an instance of V1TerminateRestrictedAssetResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1TerminateRestrictedAssetResult:
        """Create an instance of V1TerminateRestrictedAssetResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1TerminateRestrictedAssetResult.parse_obj(obj)

        _obj = V1TerminateRestrictedAssetResult.parse_obj({
