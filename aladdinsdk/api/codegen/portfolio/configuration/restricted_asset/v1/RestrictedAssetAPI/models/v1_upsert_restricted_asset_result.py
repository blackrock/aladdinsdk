...
class V1UpsertRestrictedAssetResult(BaseModel):
    """
    The Result body of the BatchUpsertRestrictedAssets call.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpsertRestrictedAssetResult:
        """Create an instance of V1UpsertRestrictedAssetResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpsertRestrictedAssetResult:
        """Create an instance of V1UpsertRestrictedAssetResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpsertRestrictedAssetResult.parse_obj(obj)

        _obj = V1UpsertRestrictedAssetResult.parse_obj({
