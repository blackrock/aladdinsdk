...
class V1UpdateRestrictedAssetResult(BaseModel):
    """
    The Result body of the BatchUpdateRestrictedAssets call.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateRestrictedAssetResult:
        """Create an instance of V1UpdateRestrictedAssetResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateRestrictedAssetResult:
        """Create an instance of V1UpdateRestrictedAssetResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateRestrictedAssetResult.parse_obj(obj)

        _obj = V1UpdateRestrictedAssetResult.parse_obj({
