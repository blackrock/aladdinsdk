...
class V1ValidateBrokerExternalAliasRequest(BaseModel):
    """
    The request message for BrokerDeskAPI.ValidateBrokerExternalAlias.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ValidateBrokerExternalAliasRequest:
        """Create an instance of V1ValidateBrokerExternalAliasRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ValidateBrokerExternalAliasRequest:
        """Create an instance of V1ValidateBrokerExternalAliasRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ValidateBrokerExternalAliasRequest.parse_obj(obj)

        _obj = V1ValidateBrokerExternalAliasRequest.parse_obj({
