...
class V1UpdateBrokerExternalAliasRequest(BaseModel):
    """
    V1UpdateBrokerExternalAliasRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateBrokerExternalAliasRequest:
        """Create an instance of V1UpdateBrokerExternalAliasRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateBrokerExternalAliasRequest:
        """Create an instance of V1UpdateBrokerExternalAliasRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateBrokerExternalAliasRequest.parse_obj(obj)

        _obj = V1UpdateBrokerExternalAliasRequest.parse_obj({
