...
class V1FilterBrokerExternalAliasesResponse(BaseModel):
    """
    The response message for BrokerExternalAliasAPI.FilterBrokerExternalAliasesResponse.
    """
    ...
    __properties = ["brokerExternalAliases", "nextPageToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1FilterBrokerExternalAliasesResponse:
        """Create an instance of V1FilterBrokerExternalAliasesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1FilterBrokerExternalAliasesResponse:
        """Create an instance of V1FilterBrokerExternalAliasesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1FilterBrokerExternalAliasesResponse.parse_obj(obj)

        _obj = V1FilterBrokerExternalAliasesResponse.parse_obj({
