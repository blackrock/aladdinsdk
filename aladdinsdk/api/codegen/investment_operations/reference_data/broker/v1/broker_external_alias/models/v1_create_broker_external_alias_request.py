...
class V1CreateBrokerExternalAliasRequest(BaseModel):
    """
    V1CreateBrokerExternalAliasRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateBrokerExternalAliasRequest:
        """Create an instance of V1CreateBrokerExternalAliasRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateBrokerExternalAliasRequest:
        """Create an instance of V1CreateBrokerExternalAliasRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateBrokerExternalAliasRequest.parse_obj(obj)

        _obj = V1CreateBrokerExternalAliasRequest.parse_obj({
