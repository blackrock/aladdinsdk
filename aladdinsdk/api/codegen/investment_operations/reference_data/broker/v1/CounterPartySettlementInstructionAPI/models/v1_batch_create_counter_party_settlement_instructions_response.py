...
class V1BatchCreateCounterPartySettlementInstructionsResponse(BaseModel):
    """
    The response message for CounterPartySettlementInstructionAPI.BatchCreateCounterPartySettlementInstructions.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchCreateCounterPartySettlementInstructionsResponse:
        """Create an instance of V1BatchCreateCounterPartySettlementInstructionsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchCreateCounterPartySettlementInstructionsResponse:
        """Create an instance of V1BatchCreateCounterPartySettlementInstructionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchCreateCounterPartySettlementInstructionsResponse.parse_obj(obj)

        _obj = V1BatchCreateCounterPartySettlementInstructionsResponse.parse_obj({
