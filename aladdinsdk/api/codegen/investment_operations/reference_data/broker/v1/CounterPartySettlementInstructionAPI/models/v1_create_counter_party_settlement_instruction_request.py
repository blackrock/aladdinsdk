...
class V1CreateCounterPartySettlementInstructionRequest(BaseModel):
    """
    V1CreateCounterPartySettlementInstructionRequest
    """
    ...
    auto_approved: Optional[StrictBool] = Field(None, alias="autoApproved")
    __properties = ["counterPartySettlementInstruction", "autoApproved"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateCounterPartySettlementInstructionRequest:
        """Create an instance of V1CreateCounterPartySettlementInstructionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateCounterPartySettlementInstructionRequest:
        """Create an instance of V1CreateCounterPartySettlementInstructionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateCounterPartySettlementInstructionRequest.parse_obj(obj)

        _obj = V1CreateCounterPartySettlementInstructionRequest.parse_obj({
            ...
            "auto_approved": obj.get("autoApproved")
        })
        return _obj
