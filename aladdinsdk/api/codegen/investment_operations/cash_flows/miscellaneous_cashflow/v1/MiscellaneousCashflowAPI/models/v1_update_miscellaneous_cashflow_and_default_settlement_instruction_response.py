...
class V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse(BaseModel):
    """
    V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse:
        """Create an instance of V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse:
        """Create an instance of V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse.parse_obj(obj)

        _obj = V1UpdateMiscellaneousCashflowAndDefaultSettlementInstructionResponse.parse_obj({
