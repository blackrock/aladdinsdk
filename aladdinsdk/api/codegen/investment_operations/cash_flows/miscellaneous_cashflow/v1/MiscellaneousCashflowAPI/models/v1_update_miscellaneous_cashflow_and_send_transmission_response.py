...
class V1UpdateMiscellaneousCashflowAndSendTransmissionResponse(BaseModel):
    """
    V1UpdateMiscellaneousCashflowAndSendTransmissionResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateMiscellaneousCashflowAndSendTransmissionResponse:
        """Create an instance of V1UpdateMiscellaneousCashflowAndSendTransmissionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateMiscellaneousCashflowAndSendTransmissionResponse:
        """Create an instance of V1UpdateMiscellaneousCashflowAndSendTransmissionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateMiscellaneousCashflowAndSendTransmissionResponse.parse_obj(obj)

        _obj = V1UpdateMiscellaneousCashflowAndSendTransmissionResponse.parse_obj({
