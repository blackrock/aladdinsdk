...
class V1CreateMiscellaneousCashflowAndSendTransmissionRequest(BaseModel):
    """
    ...
    __properties = ["miscellaneousCashflow", "validateOnly"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateMiscellaneousCashflowAndSendTransmissionRequest:
        """Create an instance of V1CreateMiscellaneousCashflowAndSendTransmissionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateMiscellaneousCashflowAndSendTransmissionRequest:
        """Create an instance of V1CreateMiscellaneousCashflowAndSendTransmissionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateMiscellaneousCashflowAndSendTransmissionRequest.parse_obj(obj)

        _obj = V1CreateMiscellaneousCashflowAndSendTransmissionRequest.parse_obj({
