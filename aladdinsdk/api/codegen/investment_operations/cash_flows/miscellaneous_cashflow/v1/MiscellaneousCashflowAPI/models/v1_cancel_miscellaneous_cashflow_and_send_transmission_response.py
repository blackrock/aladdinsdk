...
class V1CancelMiscellaneousCashflowAndSendTransmissionResponse(BaseModel):
    """
    V1CancelMiscellaneousCashflowAndSendTransmissionResponse
    """
    miscellaneous_cashflow: Optional[V1MiscellaneousCashflow] = Field(None, alias="miscellaneousCashflow")
    __properties = ["miscellaneousCashflow"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CancelMiscellaneousCashflowAndSendTransmissionResponse:
        """Create an instance of V1CancelMiscellaneousCashflowAndSendTransmissionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CancelMiscellaneousCashflowAndSendTransmissionResponse:
        """Create an instance of V1CancelMiscellaneousCashflowAndSendTransmissionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CancelMiscellaneousCashflowAndSendTransmissionResponse.parse_obj(obj)

        _obj = V1CancelMiscellaneousCashflowAndSendTransmissionResponse.parse_obj({
