...
class V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest(BaseModel):
    """
    V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest
    """
    ...
    suppress_defaulting_error: Optional[StrictBool] = Field(None, alias="suppressDefaultingError")
    __properties = ["miscellaneousCashflow", "validateOnly", "suppressDefaultingError"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest:
        """Create an instance of V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest:
        """Create an instance of V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest.parse_obj(obj)

        _obj = V1CreateMiscellaneousCashflowAndDefaultSettlementInstructionRequest.parse_obj({
            ...
            "suppress_defaulting_error": obj.get("suppressDefaultingError")
        })
        return _obj
