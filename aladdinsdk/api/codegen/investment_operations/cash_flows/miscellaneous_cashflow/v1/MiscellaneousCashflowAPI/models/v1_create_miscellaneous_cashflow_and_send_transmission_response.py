...
class V1CreateMiscellaneousCashflowAndSendTransmissionResponse(BaseModel):
    """
    V1CreateMiscellaneousCashflowAndSendTransmissionResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateMiscellaneousCashflowAndSendTransmissionResponse:
        """Create an instance of V1CreateMiscellaneousCashflowAndSendTransmissionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateMiscellaneousCashflowAndSendTransmissionResponse:
        """Create an instance of V1CreateMiscellaneousCashflowAndSendTransmissionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateMiscellaneousCashflowAndSendTransmissionResponse.parse_obj(obj)

        _obj = V1CreateMiscellaneousCashflowAndSendTransmissionResponse.parse_obj({
