...
class V1CancelMiscellaneousCashflowRequest(BaseModel):
    """
    V1CancelMiscellaneousCashflowRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CancelMiscellaneousCashflowRequest:
        """Create an instance of V1CancelMiscellaneousCashflowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CancelMiscellaneousCashflowRequest:
        """Create an instance of V1CancelMiscellaneousCashflowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CancelMiscellaneousCashflowRequest.parse_obj(obj)

        _obj = V1CancelMiscellaneousCashflowRequest.parse_obj({
