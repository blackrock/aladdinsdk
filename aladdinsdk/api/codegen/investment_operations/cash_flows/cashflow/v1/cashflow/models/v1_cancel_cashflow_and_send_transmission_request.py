...
class V1CancelCashflowAndSendTransmissionRequest(BaseModel):
    """
    V1CancelCashflowAndSendTransmissionRequest
    """
    ...
    __properties = ["cashflow", "validateOnly", "updateExternId1"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CancelCashflowAndSendTransmissionRequest:
        """Create an instance of V1CancelCashflowAndSendTransmissionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CancelCashflowAndSendTransmissionRequest:
        """Create an instance of V1CancelCashflowAndSendTransmissionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CancelCashflowAndSendTransmissionRequest.parse_obj(obj)

        _obj = V1CancelCashflowAndSendTransmissionRequest.parse_obj({
