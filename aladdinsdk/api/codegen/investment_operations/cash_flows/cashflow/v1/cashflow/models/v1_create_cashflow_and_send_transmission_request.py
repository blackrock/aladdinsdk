...
class V1CreateCashflowAndSendTransmissionRequest(BaseModel):
    """
    The request message for CashflowTransmissionAPI.CreateCashflowAndSendTransmission.
    """
    cashflow: Optional[V1Cashflow] = None
    validate_only: Optional[StrictBool] = Field(None, alias="validateOnly")
    __properties = ["cashflow", "validateOnly"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateCashflowAndSendTransmissionRequest:
        """Create an instance of V1CreateCashflowAndSendTransmissionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateCashflowAndSendTransmissionRequest:
        """Create an instance of V1CreateCashflowAndSendTransmissionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateCashflowAndSendTransmissionRequest.parse_obj(obj)

        _obj = V1CreateCashflowAndSendTransmissionRequest.parse_obj({
