...
class V1CancelCashflowAndSendTransmissionResponse(BaseModel):
    """
    V1CancelCashflowAndSendTransmissionResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CancelCashflowAndSendTransmissionResponse:
        """Create an instance of V1CancelCashflowAndSendTransmissionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CancelCashflowAndSendTransmissionResponse:
        """Create an instance of V1CancelCashflowAndSendTransmissionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CancelCashflowAndSendTransmissionResponse.parse_obj(obj)

        _obj = V1CancelCashflowAndSendTransmissionResponse.parse_obj({
