...
class V1CancelCashflowRequest(BaseModel):
    """
    V1CancelCashflowRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CancelCashflowRequest:
        """Create an instance of V1CancelCashflowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CancelCashflowRequest:
        """Create an instance of V1CancelCashflowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CancelCashflowRequest.parse_obj(obj)

        _obj = V1CancelCashflowRequest.parse_obj({
