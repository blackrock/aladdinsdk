...
class CashflowAPICreateCashflow400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashflowAPICreateCashflow400Response:
        """Create an instance of CashflowAPICreateCashflow400Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashflowAPICreateCashflow400Response:
        """Create an instance of CashflowAPICreateCashflow400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashflowAPICreateCashflow400Response.parse_obj(obj)

        _obj = CashflowAPICreateCashflow400Response.parse_obj({
            "code": obj.get("code"),
