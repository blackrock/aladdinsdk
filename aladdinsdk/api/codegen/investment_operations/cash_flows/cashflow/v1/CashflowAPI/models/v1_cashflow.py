...
class V1Cashflow(BaseModel):
    ...
    cashflow_investment_number: Optional[StrictInt] = Field(None, alias="cashflowInvestmentNumber")
    ...
    cashflow_trade_date: Optional[date] = Field(None, alias="cashflowTradeDate")
    cashflow_settle_date: Optional[date] = Field(None, alias="cashflowSettleDate")
    cashflow_status: Optional[StrictStr] = Field(None, alias="cashflowStatus")
    cashflow_transaction_type: Optional[V1TransactionType] = Field(None, alias="cashflowTransactionType")
    cashflow_sub_transaction_type: Optional[StrictStr] = Field(None, alias="cashflowSubTransactionType")
    ...
    cashflow_strategy_id: Optional[StrictInt] = Field(None, alias="cashflowStrategyId")
    cashflow_exchange_rate: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="cashflowExchangeRate")
    ...
    cashflow_price: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="cashflowPrice")
    ...
    cashflow_version: Optional[StrictInt] = Field(None, alias="cashflowVersion")
    __properties = ["id", "portfolioId", "cashflowInvestmentNumber", "seriesNumber", "currencyCode", "brokerId", "principal", "interest", "commission", "otherFee", "originalFace", "assetId", "cashflowTradeDate", "cashflowSettleDate", "cashflowStatus", "cashflowTransactionType", "cashflowSubTransactionType", "enteredBy", "trader", "confirmedBy", "reviewedBy", "entryTime", "modifyTime", "authorizeTime", "reviewTime", "cashflowStrategyId", "cashflowExchangeRate", "actualSettleDate", "settledAmount", "settlementInstructionId", "clientPaymentReference", "cashflowCommentText", "cashflowCommentByte", "cashflowExternalId", "factor", "cashflowPrice", "tradePar", "shortIndicator", "structuredBy", "settlementConfirmed", "duplicateNumber", "source", "cashflowVersion"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Cashflow:
        """Create an instance of V1Cashflow from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Cashflow:
        """Create an instance of V1Cashflow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1Cashflow.parse_obj(obj)

        _obj = V1Cashflow.parse_obj({
            "id": obj.get("id"),
            "portfolio_id": obj.get("portfolioId"),
            "cashflow_investment_number": obj.get("cashflowInvestmentNumber"),
            ...
            "cashflow_trade_date": obj.get("cashflowTradeDate"),
            "cashflow_settle_date": obj.get("cashflowSettleDate"),
            "cashflow_status": obj.get("cashflowStatus"),
            "cashflow_transaction_type": obj.get("cashflowTransactionType"),
            "cashflow_sub_transaction_type": obj.get("cashflowSubTransactionType"),
            ...
            "cashflow_strategy_id": obj.get("cashflowStrategyId"),
            "cashflow_exchange_rate": obj.get("cashflowExchangeRate"),
            ...
            "cashflow_price": obj.get("cashflowPrice"),
            ...
            "cashflow_version": obj.get("cashflowVersion")
        })
        return _obj
