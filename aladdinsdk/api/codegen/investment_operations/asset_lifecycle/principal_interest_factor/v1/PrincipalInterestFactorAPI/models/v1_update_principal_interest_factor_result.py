...
class V1UpdatePrincipalInterestFactorResult(BaseModel):
    """
    V1UpdatePrincipalInterestFactorResult
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdatePrincipalInterestFactorResult:
        """Create an instance of V1UpdatePrincipalInterestFactorResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdatePrincipalInterestFactorResult:
        """Create an instance of V1UpdatePrincipalInterestFactorResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdatePrincipalInterestFactorResult.parse_obj(obj)

        _obj = V1UpdatePrincipalInterestFactorResult.parse_obj({
