...
class V1UpdatePrincipalInterestFactorRequest(BaseModel):
    """
    V1UpdatePrincipalInterestFactorRequest
    """
    ...
    __properties = ["principalInterestFactor", "updateMask"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdatePrincipalInterestFactorRequest:
        """Create an instance of V1UpdatePrincipalInterestFactorRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdatePrincipalInterestFactorRequest:
        """Create an instance of V1UpdatePrincipalInterestFactorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdatePrincipalInterestFactorRequest.parse_obj(obj)

        _obj = V1UpdatePrincipalInterestFactorRequest.parse_obj({
