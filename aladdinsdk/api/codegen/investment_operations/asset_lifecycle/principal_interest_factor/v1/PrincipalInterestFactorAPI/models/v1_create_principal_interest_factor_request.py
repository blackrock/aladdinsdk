...
class V1CreatePrincipalInterestFactorRequest(BaseModel):
    """
    V1CreatePrincipalInterestFactorRequest
    """
    principal_interest_factor: Optional[V1PrincipalInterestFactor] = Field(None, alias="principalInterestFactor")
    __properties = ["principalInterestFactor"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreatePrincipalInterestFactorRequest:
        """Create an instance of V1CreatePrincipalInterestFactorRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreatePrincipalInterestFactorRequest:
        """Create an instance of V1CreatePrincipalInterestFactorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreatePrincipalInterestFactorRequest.parse_obj(obj)

        _obj = V1CreatePrincipalInterestFactorRequest.parse_obj({
