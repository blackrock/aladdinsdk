...
class V1AssetFilter(BaseModel):
    """
    V1AssetFilter
    """
    security_group: StrictStr = Field(..., alias="securityGroup")
    security_type: Optional[StrictStr] = Field(None, alias="securityType")
    __properties = ["securityGroup", "securityType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1AssetFilter:
        """Create an instance of V1AssetFilter from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1AssetFilter:
        """Create an instance of V1AssetFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1AssetFilter.parse_obj(obj)

        _obj = V1AssetFilter.parse_obj({
