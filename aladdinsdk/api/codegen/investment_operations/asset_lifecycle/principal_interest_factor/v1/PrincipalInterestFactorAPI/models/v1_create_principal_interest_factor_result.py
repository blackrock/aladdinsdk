...
class V1CreatePrincipalInterestFactorResult(BaseModel):
    """
    V1CreatePrincipalInterestFactorResult
    """
    error: Optional[RpcStatus] = None
    output: Optional[V1PrincipalInterestFactor] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreatePrincipalInterestFactorResult:
        """Create an instance of V1CreatePrincipalInterestFactorResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreatePrincipalInterestFactorResult:
        """Create an instance of V1CreatePrincipalInterestFactorResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreatePrincipalInterestFactorResult.parse_obj(obj)

        _obj = V1CreatePrincipalInterestFactorResult.parse_obj({
            "error": RpcStatus.from_dict(obj.get("error")) if obj.get("error") is not None else None,
            "output": V1PrincipalInterestFactor.from_dict(obj.get("output")) if obj.get("output") is not None else None
        })
        return _obj
