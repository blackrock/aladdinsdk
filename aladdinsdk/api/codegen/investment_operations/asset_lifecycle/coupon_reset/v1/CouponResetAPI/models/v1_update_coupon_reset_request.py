...
class V1UpdateCouponResetRequest(BaseModel):
    """
    V1UpdateCouponResetRequest
    """
    ...
    __properties = ["couponReset", "updateMask"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateCouponResetRequest:
        """Create an instance of V1UpdateCouponResetRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateCouponResetRequest:
        """Create an instance of V1UpdateCouponResetRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateCouponResetRequest.parse_obj(obj)

        _obj = V1UpdateCouponResetRequest.parse_obj({
