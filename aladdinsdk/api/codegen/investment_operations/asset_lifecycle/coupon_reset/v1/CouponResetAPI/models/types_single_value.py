...
class TypesSingleValue(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TypesSingleValue:
        """Create an instance of TypesSingleValue from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TypesSingleValue:
        """Create an instance of TypesSingleValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TypesSingleValue.parse_obj(obj)

        _obj = TypesSingleValue.parse_obj({
