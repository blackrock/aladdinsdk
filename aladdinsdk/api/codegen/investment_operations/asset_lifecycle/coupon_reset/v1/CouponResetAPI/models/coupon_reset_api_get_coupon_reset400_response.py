...
class CouponResetAPIGetCouponReset400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CouponResetAPIGetCouponReset400Response:
        """Create an instance of CouponResetAPIGetCouponReset400Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CouponResetAPIGetCouponReset400Response:
        """Create an instance of CouponResetAPIGetCouponReset400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CouponResetAPIGetCouponReset400Response.parse_obj(obj)

        _obj = CouponResetAPIGetCouponReset400Response.parse_obj({
            "code": obj.get("code"),
