...
class V1BatchValidateEnrichedCapitalFlowsRequest(BaseModel):
    """
    V1BatchValidateEnrichedCapitalFlowsRequest
    """
    enriched_capital_flows: conlist(V1EnrichedCapitalFlow) = Field(..., alias="enrichedCapitalFlows")
    __properties = ["enrichedCapitalFlows"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchValidateEnrichedCapitalFlowsRequest:
        """Create an instance of V1BatchValidateEnrichedCapitalFlowsRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchValidateEnrichedCapitalFlowsRequest:
        """Create an instance of V1BatchValidateEnrichedCapitalFlowsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchValidateEnrichedCapitalFlowsRequest.parse_obj(obj)

        _obj = V1BatchValidateEnrichedCapitalFlowsRequest.parse_obj({
