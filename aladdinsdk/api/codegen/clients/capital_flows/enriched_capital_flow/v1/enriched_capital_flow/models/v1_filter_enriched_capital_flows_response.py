...
class V1FilterEnrichedCapitalFlowsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1FilterEnrichedCapitalFlowsResponse:
        """Create an instance of V1FilterEnrichedCapitalFlowsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1FilterEnrichedCapitalFlowsResponse:
        """Create an instance of V1FilterEnrichedCapitalFlowsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1FilterEnrichedCapitalFlowsResponse.parse_obj(obj)

        _obj = V1FilterEnrichedCapitalFlowsResponse.parse_obj({
