...
class DefaultEnrichedCapitalFlowAPI(object):
    ...
    @validate_arguments
    def enriched_capital_flow_api_batch_transition_enriched_capital_flows(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], body : V1BatchTransitionEnrichedCapitalFlowsRequest, **kwargs) -> V1BatchTransitionEnrichedCapitalFlowsResponse:  # noqa: E501
        """Transition capital flows to given state  # noqa: E501

        User would require standard newcash permissions to perform action(s) based on business workflow and user's role (Standard newcash permissions are: VIEW_NEWCASH, CASH_PAY, CASH_MOD, CASH_CONF, ASSET_MOD, ASSET_CONF, CASH_TRANSFER, ASSET_TRANSFER).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.enriched_capital_flow_api_batch_transition_enriched_capital_flows(vnd_com_blackrock_request_id, vnd_com_blackrock_origin_timestamp, body, async_req=True)
        >>> result = thread.get()
        ...
        :param body: (required)
        :type body: V1BatchTransitionEnrichedCapitalFlowsRequest
        ...
        :rtype: V1BatchTransitionEnrichedCapitalFlowsResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the enriched_capital_flow_api_batch_transition_enriched_capital_flows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.enriched_capital_flow_api_batch_transition_enriched_capital_flows_with_http_info(vnd_com_blackrock_request_id, vnd_com_blackrock_origin_timestamp, body, **kwargs)  # noqa: E501

    @validate_arguments
    def enriched_capital_flow_api_batch_transition_enriched_capital_flows_with_http_info(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], body : V1BatchTransitionEnrichedCapitalFlowsRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Transition capital flows to given state  # noqa: E501
        ...
        >>> thread = api.enriched_capital_flow_api_batch_transition_enriched_capital_flows_with_http_info(vnd_com_blackrock_request_id, vnd_com_blackrock_origin_timestamp, body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1BatchTransitionEnrichedCapitalFlowsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method enriched_capital_flow_api_batch_transition_enriched_capital_flows" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "V1BatchTransitionEnrichedCapitalFlowsResponse",
        ...
        return self.api_client.call_api(
            '/enrichedCapitalFlows:batchTransition', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
