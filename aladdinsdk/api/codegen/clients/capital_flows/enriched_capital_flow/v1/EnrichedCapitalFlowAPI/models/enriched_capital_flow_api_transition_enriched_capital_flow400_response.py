...
class EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response:
        """Create an instance of EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response:
        """Create an instance of EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response.parse_obj(obj)

        _obj = EnrichedCapitalFlowAPITransitionEnrichedCapitalFlow400Response.parse_obj({
            "code": obj.get("code"),
