...
import aladdinsdk.api.codegen.accounting.configuration.composite_membership.v1.CompositeMembershipAPI.models
from aladdinsdk.api.codegen.accounting.configuration.composite_membership.v1.CompositeMembershipAPI import rest
from aladdinsdk.api.codegen.accounting.configuration.composite_membership.v1.CompositeMembershipAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.accounting.configuration.composite_membership.v1.CompositeMembershipAPI.models, klass)
