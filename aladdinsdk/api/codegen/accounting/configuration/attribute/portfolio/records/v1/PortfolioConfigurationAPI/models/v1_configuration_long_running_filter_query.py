...
class V1ConfigurationLongRunningFilterQuery(BaseModel):
    """
    ...
    __properties = ["tickers", "processCodes", "accountingAttributeNames", "accountingAttributesValueCriteria", "asOfDate", "includeHistory", "expansionType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ConfigurationLongRunningFilterQuery:
        """Create an instance of V1ConfigurationLongRunningFilterQuery from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ConfigurationLongRunningFilterQuery:
        """Create an instance of V1ConfigurationLongRunningFilterQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ConfigurationLongRunningFilterQuery.parse_obj(obj)

        _obj = V1ConfigurationLongRunningFilterQuery.parse_obj({
