...
class V1ConfigurationLongRunningMetaData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ConfigurationLongRunningMetaData:
        """Create an instance of V1ConfigurationLongRunningMetaData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ConfigurationLongRunningMetaData:
        """Create an instance of V1ConfigurationLongRunningMetaData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ConfigurationLongRunningMetaData.parse_obj(obj)

        _obj = V1ConfigurationLongRunningMetaData.parse_obj({
