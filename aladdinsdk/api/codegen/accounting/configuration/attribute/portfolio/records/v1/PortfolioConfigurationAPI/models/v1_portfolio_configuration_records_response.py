...
class V1PortfolioConfigurationRecordsResponse(BaseModel):
    """
    ...
    __properties = ["portfolioConfigurationRecords"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1PortfolioConfigurationRecordsResponse:
        """Create an instance of V1PortfolioConfigurationRecordsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1PortfolioConfigurationRecordsResponse:
        """Create an instance of V1PortfolioConfigurationRecordsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1PortfolioConfigurationRecordsResponse.parse_obj(obj)

        _obj = V1PortfolioConfigurationRecordsResponse.parse_obj({
