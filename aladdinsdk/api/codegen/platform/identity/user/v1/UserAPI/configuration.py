...
conf = aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI.Configuration(
...
conf = aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://localhost/api/platform/identity/user/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "/api/platform/identity/user/v1",
