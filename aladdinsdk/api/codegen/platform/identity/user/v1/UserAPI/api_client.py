...
import aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI.models
from aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI import rest
from aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI.models, klass)
