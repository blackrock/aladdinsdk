...
from aladdinsdk.api.codegen.platform.identity.user.v1.UserAPI.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError
