...
class V1AlternateId(BaseModel):
    """
    V1AlternateId
    """
    alternate_id_key: StrictStr = Field(..., alias="alternateIdKey")
    alternate_id_value: StrictStr = Field(..., alias="alternateIdValue")
    __properties = ["alternateIdKey", "alternateIdValue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1AlternateId:
        """Create an instance of V1AlternateId from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1AlternateId:
        """Create an instance of V1AlternateId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1AlternateId.parse_obj(obj)

        _obj = V1AlternateId.parse_obj({
            "alternate_id_key": obj.get("alternateIdKey"),
            "alternate_id_value": obj.get("alternateIdValue")
        })
        return _obj
