...
conf = aladdinsdk.api.codegen.platform.identity.user.v1.user.Configuration(
...
conf = aladdinsdk.api.codegen.platform.identity.user.v1.user.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("aladdinsdk.api.codegen.platform.identity.user.v1.user")
