...
import aladdinsdk.api.codegen.platform.identity.user.v1.user.models
from aladdinsdk.api.codegen.platform.identity.user.v1.user import rest
from aladdinsdk.api.codegen.platform.identity.user.v1.user.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.platform.identity.user.v1.user.models, klass)
