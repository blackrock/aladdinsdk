...
from aladdinsdk.api.codegen.platform.access.permission.v1.UserGroupPermissionAPI.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError
