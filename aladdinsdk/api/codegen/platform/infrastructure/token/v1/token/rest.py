...
from aladdinsdk.api.codegen.platform.infrastructure.token.v1.token.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError
