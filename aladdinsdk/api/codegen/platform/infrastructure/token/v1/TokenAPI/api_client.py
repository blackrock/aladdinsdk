...
import aladdinsdk.api.codegen.platform.infrastructure.token.v1.TokenAPI.models
from aladdinsdk.api.codegen.platform.infrastructure.token.v1.TokenAPI import rest
from aladdinsdk.api.codegen.platform.infrastructure.token.v1.TokenAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.platform.infrastructure.token.v1.TokenAPI.models, klass)
