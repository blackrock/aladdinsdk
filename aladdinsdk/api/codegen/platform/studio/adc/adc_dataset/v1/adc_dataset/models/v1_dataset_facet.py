...
class V1DatasetFacet(BaseModel):
    ...
    data_owners: Optional[List[StrictStr]] = Field(None, alias="dataOwners")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1DatasetFacet:
        """Create an instance of V1DatasetFacet from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1DatasetFacet:
        """Create an instance of V1DatasetFacet from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1DatasetFacet.parse_obj(obj)

        _obj = V1DatasetFacet.parse_obj({
