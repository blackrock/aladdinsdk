...
class V1AdcDataset(BaseModel):
    ...
    target_ddl_commands: Optional[List[StrictStr]] = Field(None, alias="targetDdlCommands", description="Target DDL is either auto-generated or user provided DDL script. It is stored as a list of DDL commands to be executed for dataset creation.")
    ...
    underlying_datasets: Optional[List[StrictStr]] = Field(None, alias="underlyingDatasets")
    ...
    primary_keys: Optional[List[StrictStr]] = Field(None, alias="primaryKeys")
    ...
    def from_dict(cls, obj: dict) -> V1AdcDataset:
        ...
        _obj = V1AdcDataset.parse_obj({
            ...
            "column_metadata": dict((_k, Dict[str, V1ColumnMetadata].from_dict(_v)) for _k, _v in obj.get("columnMetadata").items()),
