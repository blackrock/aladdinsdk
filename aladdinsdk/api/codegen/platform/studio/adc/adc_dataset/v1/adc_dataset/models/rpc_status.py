...
class RpcStatus(BaseModel):
    ...
    details: Optional[List[Any]] = Field(None, description="A list of messages that carry the error details.  There is a common set of message types for APIs to use.")
