...
class V2AdcDatasetId(BaseModel):
    """
    V2AdcDatasetId
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2AdcDatasetId:
        """Create an instance of V2AdcDatasetId from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2AdcDatasetId:
        """Create an instance of V2AdcDatasetId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2AdcDatasetId.parse_obj(obj)

        _obj = V2AdcDatasetId.parse_obj({
