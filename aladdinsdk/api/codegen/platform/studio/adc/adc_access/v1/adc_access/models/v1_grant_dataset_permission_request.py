...
class V1GrantDatasetPermissionRequest(BaseModel):
    """
    The request message for AdcAccessAPI.GrantDatasetPermission.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1GrantDatasetPermissionRequest:
        """Create an instance of V1GrantDatasetPermissionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1GrantDatasetPermissionRequest:
        """Create an instance of V1GrantDatasetPermissionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1GrantDatasetPermissionRequest.parse_obj(obj)

        _obj = V1GrantDatasetPermissionRequest.parse_obj({
