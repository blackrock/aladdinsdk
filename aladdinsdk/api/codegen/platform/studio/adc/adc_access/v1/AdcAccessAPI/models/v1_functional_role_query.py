...
class V1FunctionalRoleQuery(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1FunctionalRoleQuery:
        """Create an instance of V1FunctionalRoleQuery from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1FunctionalRoleQuery:
        """Create an instance of V1FunctionalRoleQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1FunctionalRoleQuery.parse_obj(obj)

        _obj = V1FunctionalRoleQuery.parse_obj({
            "mode": obj.get("mode"),
