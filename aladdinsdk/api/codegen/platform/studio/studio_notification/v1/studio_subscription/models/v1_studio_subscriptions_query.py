...
class V1StudioSubscriptionsQuery(BaseModel):
    """
    The query required to perform a filter studio subscription call.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1StudioSubscriptionsQuery:
        """Create an instance of V1StudioSubscriptionsQuery from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1StudioSubscriptionsQuery:
        """Create an instance of V1StudioSubscriptionsQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1StudioSubscriptionsQuery.parse_obj(obj)

        _obj = V1StudioSubscriptionsQuery.parse_obj({
