...
from aladdinsdk.api.codegen.investment_research.content.research_note.v1.research_note.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class DefaultResearchNoteAPI(object):
    ...
    @validate_arguments
    def research_note_api_create_research_note_with_http_info(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], body : Annotated[V1ResearchNote, Field(..., description="research to create.")], **kwargs):  # noqa: E501
        """Creates a research note  # noqa: E501
    ...
    @validate_arguments
    def research_note_api_delete_research_note_with_http_info(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], id : Annotated[StrictStr, Field(..., description="Name of the Research")], **kwargs):  # noqa: E501
        """Deletes a research note  # noqa: E501
    ...
    @validate_arguments
    def research_note_api_get_research_note_with_http_info(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], id : Annotated[StrictStr, Field(..., description="Research Id")], **kwargs):  # noqa: E501
        """Gets a research note  # noqa: E501
    ...
    @validate_arguments
    def research_note_api_get_user_preferences_with_http_info(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], **kwargs):  # noqa: E501
        """Gets a user's preferences  # noqa: E501
