...
class V1InvestmentStewardshipDetail(BaseModel):
    ...
    external_attendees: Optional[List[StrictStr]] = Field(None, alias="externalAttendees", description="External attendees.")
    internal_attendees: Optional[List[StrictStr]] = Field(None, alias="internalAttendees", description="Internal attendees.")
    ...
    topics: Optional[List[V1InvestmentStewardshipTopicDetails]] = Field(None, description="Topics text.")
    fixed_keywords: Optional[List[V1InvestmentStewardshipFixedKeyword]] = Field(None, alias="fixedKeywords")
