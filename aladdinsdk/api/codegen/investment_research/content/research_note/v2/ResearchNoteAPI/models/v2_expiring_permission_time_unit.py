...
class V2ExpiringPermissionTimeUnit(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2ExpiringPermissionTimeUnit:
        """Create an instance of V2ExpiringPermissionTimeUnit from a JSON string"""
        return V2ExpiringPermissionTimeUnit(json.loads(json_str))
