...
class V1SearchEngagementsRequest(BaseModel):
    """
    V1SearchEngagementsRequest
    """
    ...
    __properties = ["asOfDate", "entityIds", "filterCriteria", "orderBy", "pageSize", "pageToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SearchEngagementsRequest:
        """Create an instance of V1SearchEngagementsRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SearchEngagementsRequest:
        """Create an instance of V1SearchEngagementsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1SearchEngagementsRequest.parse_obj(obj)

        _obj = V1SearchEngagementsRequest.parse_obj({
