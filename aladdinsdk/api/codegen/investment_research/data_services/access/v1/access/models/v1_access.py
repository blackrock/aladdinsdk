...
class V1Access(BaseModel):
    """
    V1Access
    """
    view_name: StrictStr = Field(..., alias="viewName", description="Represents the View or table name as it appears in Snowflake.")
    sf_columns: Optional[conlist(StrictStr)] = Field(None, alias="sfColumns")
    query_filter: Optional[StrictStr] = Field(None, alias="queryFilter")
    ...
    __properties = ["viewName", "sfColumns", "queryFilter", "filterBindVariables", "snfDataformat", "snfRecordSize", "snfTimeOut", "snfRole", "snfWarehouse", "snfDatabase", "snfSchema", "snfMaxFileSize", "snfPartition"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Access:
        """Create an instance of V1Access from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Access:
        """Create an instance of V1Access from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1Access.parse_obj(obj)

        _obj = V1Access.parse_obj({
            "view_name": obj.get("viewName"),
            "sf_columns": obj.get("sfColumns"),
            "query_filter": obj.get("queryFilter"),
