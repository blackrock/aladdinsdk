...
class V1TimeseriesMeasure(BaseModel):
    """
    V1TimeseriesMeasure
    """
    id: StrictStr = Field(..., description="Example: `PX_LAST`")
    description: Optional[StrictStr] = Field(None, description="Description of measure.  Example: `Price of a security`  (-- api-linter: core::0124::required-reference=disabled aip.dev/not-precedent: We need to do this because description is a field to describe a measure --) (-- api-linter: aladdin::0901::dictionary-message-field=disabled aip.dev/not-precedent: We need to do this because this resource conflicts with another that is not in our domain --) Measure Description")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1TimeseriesMeasure:
        """Create an instance of V1TimeseriesMeasure from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1TimeseriesMeasure:
        """Create an instance of V1TimeseriesMeasure from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1TimeseriesMeasure.parse_obj(obj)

        _obj = V1TimeseriesMeasure.parse_obj({
            "id": obj.get("id"),
