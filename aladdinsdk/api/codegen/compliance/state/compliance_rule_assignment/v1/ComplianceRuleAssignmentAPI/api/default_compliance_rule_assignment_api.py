...
class DefaultComplianceRuleAssignmentAPI(object):
    ...
    @validate_arguments
    def compliance_rule_assignment_api_update_compliance_rule_assignment(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], compliance_rule_assignment_id : Annotated[StrictStr, Field(..., description="Rule Assignment ID")], body : Annotated[V1ComplianceRuleAssignment, Field(..., description="ComplianceRuleAssignment to update.")], update_mask : Annotated[Optional[StrictStr], Field(description="List of fields to be updated. Warning: Please ensure you understand the implications of using a field mask. And more precisely the fact you need all fields mentioned to be present in your payload. Also, portfolios and rules configurations are linked and cannot be updated separately. If you want to add either portfolios or rules configurations to your field mask, please ensure that you add portfolios and all rules configurations.")] = None, **kwargs) -> V1ComplianceRuleAssignment:  # noqa: E501
        """Update an existing ComplianceRuleAssignment  # noqa: E501

        IMPORTANT: Portfolios and rules configurations are linked and cannot therefore be updated separately. In order to publish a change on either portfolios or rule configurations, please ensure you provide all portfolios and rules configurations you want the system to retain. Throws NOT_FOUND when record does not exist  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.compliance_rule_assignment_api_update_compliance_rule_assignment(vnd_com_blackrock_request_id, vnd_com_blackrock_origin_timestamp, compliance_rule_assignment_id, body, update_mask, async_req=True)
        >>> result = thread.get()
        ...
        :param vnd_com_blackrock_origin_timestamp: Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231. (required)
        :type vnd_com_blackrock_origin_timestamp: datetime
        :param compliance_rule_assignment_id: Rule Assignment ID (required)
        :type compliance_rule_assignment_id: str
        :param body: ComplianceRuleAssignment to update. (required)
        :type body: V1ComplianceRuleAssignment
        :param update_mask: List of fields to be updated. Warning: Please ensure you understand the implications of using a field mask. And more precisely the fact you need all fields mentioned to be present in your payload. Also, portfolios and rules configurations are linked and cannot be updated separately. If you want to add either portfolios or rules configurations to your field mask, please ensure that you add portfolios and all rules configurations.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the compliance_rule_assignment_api_update_compliance_rule_assignment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.compliance_rule_assignment_api_update_compliance_rule_assignment_with_http_info(vnd_com_blackrock_request_id, vnd_com_blackrock_origin_timestamp, compliance_rule_assignment_id, body, update_mask, **kwargs)  # noqa: E501

    @validate_arguments
    def compliance_rule_assignment_api_update_compliance_rule_assignment_with_http_info(self, vnd_com_blackrock_request_id : Annotated[StrictStr, Field(..., description="A unique identifier for this request.")], vnd_com_blackrock_origin_timestamp : Annotated[datetime, Field(..., description="Timestamp assigned to this request at origin, in \"HTTP-date\" format as defined by RFC 7231.")], compliance_rule_assignment_id : Annotated[StrictStr, Field(..., description="Rule Assignment ID")], body : Annotated[V1ComplianceRuleAssignment, Field(..., description="ComplianceRuleAssignment to update.")], update_mask : Annotated[Optional[StrictStr], Field(description="List of fields to be updated. Warning: Please ensure you understand the implications of using a field mask. And more precisely the fact you need all fields mentioned to be present in your payload. Also, portfolios and rules configurations are linked and cannot be updated separately. If you want to add either portfolios or rules configurations to your field mask, please ensure that you add portfolios and all rules configurations.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update an existing ComplianceRuleAssignment  # noqa: E501
        ...
        >>> thread = api.compliance_rule_assignment_api_update_compliance_rule_assignment_with_http_info(vnd_com_blackrock_request_id, vnd_com_blackrock_origin_timestamp, compliance_rule_assignment_id, body, update_mask, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method compliance_rule_assignment_api_update_compliance_rule_assignment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['compliance_rule_assignment_id']:
            _path_params['complianceRuleAssignment.id'] = _params['compliance_rule_assignment_id']
        ...
        return self.api_client.call_api(
            '/complianceRuleAssignments/{complianceRuleAssignment.id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
