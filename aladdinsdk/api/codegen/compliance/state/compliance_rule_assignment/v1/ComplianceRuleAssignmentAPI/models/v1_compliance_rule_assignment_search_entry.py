...
class V1ComplianceRuleAssignmentSearchEntry(BaseModel):
    """
    V1ComplianceRuleAssignmentSearchEntry
    """
    id: Optional[StrictStr] = None
    prohibition_rule_configurations: Optional[Dict[str, V1SimpleRuleConfig]] = Field(None, alias="prohibitionRuleConfigurations", description="Severity of the Prohibiion rules associated with this assignment.")
    concentration_rule_configurations: Optional[Dict[str, V1CustomizableRuleConfig]] = Field(None, alias="concentrationRuleConfigurations", description="Test details and severity of the Concentration rules associated with this assignment.")
    value_at_risk_rule_configurations: Optional[Dict[str, V1SimpleRuleConfig]] = Field(None, alias="valueAtRiskRuleConfigurations")
    scripted_rule_configurations: Optional[Dict[str, V1SimpleRuleConfig]] = Field(None, alias="scriptedRuleConfigurations", description="Severity of the Scripted rules associated with this assignment.")
    trade_rule_configurations: Optional[Dict[str, V1SimpleRuleConfig]] = Field(None, alias="tradeRuleConfigurations", description="Severity of the Trade rules associated with this assignment.")
    counterparty_rule_configurations: Optional[Dict[str, V1SimpleRuleConfig]] = Field(None, alias="counterpartyRuleConfigurations", description="Severity of the Counterparty rules associated with this assignment.")
    ...
    rule_assignment_source: Optional[StrictStr] = Field(None, alias="ruleAssignmentSource", description="Source of the Rule Assignment (e.g client Guideline or Regulatory. See Decodes table - COMPL_DOC_SRC).")
    category: Optional[StrictStr] = None
    effective_date: Optional[date] = Field(None, alias="effectiveDate", description="Date when this rule assignment was or will be activated.")
    ...
    __properties = ["id", "prohibitionRuleConfigurations", "concentrationRuleConfigurations", "valueAtRiskRuleConfigurations", "scriptedRuleConfigurations", "tradeRuleConfigurations", "counterpartyRuleConfigurations", "portfolioNames", "approvalCategory", "ruleAssignmentSource", "category", "effectiveDate", "effective", "reviewState", "reference", "labels", "regulator", "deadline", "jurisdictionCountryCode", "terminationDate", "constraintApplicabilityType", "assignmentName", "resolutionRequiresFourEyesApproval"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ComplianceRuleAssignmentSearchEntry:
        """Create an instance of V1ComplianceRuleAssignmentSearchEntry from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ComplianceRuleAssignmentSearchEntry:
        """Create an instance of V1ComplianceRuleAssignmentSearchEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ComplianceRuleAssignmentSearchEntry.parse_obj(obj)

        _obj = V1ComplianceRuleAssignmentSearchEntry.parse_obj({
            "id": obj.get("id"),
