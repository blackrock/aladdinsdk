...
class V1ViolationDetail(BaseModel):
    """
    V1ViolationDetail
    """
    ...
    __properties = ["causeType", "violationDetail", "modificationTime"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ViolationDetail:
        """Create an instance of V1ViolationDetail from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ViolationDetail:
        """Create an instance of V1ViolationDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ViolationDetail.parse_obj(obj)

        _obj = V1ViolationDetail.parse_obj({
