...
class V1ValueAtRiskRule(BaseModel):
    """
    ValueAtRiskRule Rule type.
    """
    ...
    rule_condition: StrictStr = Field(..., alias="ruleCondition")
    ...
    __properties = ["severity", "filter", "ruleCondition", "ruleWarning", "groupByValues"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ValueAtRiskRule:
        """Create an instance of V1ValueAtRiskRule from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ValueAtRiskRule:
        """Create an instance of V1ValueAtRiskRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ValueAtRiskRule.parse_obj(obj)

        _obj = V1ValueAtRiskRule.parse_obj({
