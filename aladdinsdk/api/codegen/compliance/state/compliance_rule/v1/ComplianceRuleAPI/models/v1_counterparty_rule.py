...
class V1CounterpartyRule(BaseModel):
    """
    CounterpartyRule Rule type.
    """
    ...
    list_token: StrictStr = Field(..., alias="listToken", description="Condition Token to be used in conjuction with the port list.")
    list_name: StrictStr = Field(..., alias="listName", description="The list name defines the actual broker/portfolio list that contains either a list of APPROVED or RESTRICTED brokers.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CounterpartyRule:
        """Create an instance of V1CounterpartyRule from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CounterpartyRule:
        """Create an instance of V1CounterpartyRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CounterpartyRule.parse_obj(obj)

        _obj = V1CounterpartyRule.parse_obj({
