...
class V1FieldMapping(BaseModel):
    """
    FieldMapping describes the mapping for different field in response.
    """
    field_name: Optional[StrictStr] = Field(None, alias="fieldName")
    mappings: Optional[Dict[str, StrictStr]] = None
    __properties = ["fieldName", "mappings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1FieldMapping:
        """Create an instance of V1FieldMapping from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1FieldMapping:
        """Create an instance of V1FieldMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1FieldMapping.parse_obj(obj)

        _obj = V1FieldMapping.parse_obj({
