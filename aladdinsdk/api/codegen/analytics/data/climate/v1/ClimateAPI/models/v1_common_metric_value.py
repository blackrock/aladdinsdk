...
class V1CommonMetricValue(BaseModel):
    """
    V1CommonMetricValue
    """
    ...
    map_values: Optional[Dict[str, StrictStr]] = Field(None, alias="mapValues")
    __properties = ["valueString", "valueNumeric", "mapValues"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CommonMetricValue:
        """Create an instance of V1CommonMetricValue from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CommonMetricValue:
        """Create an instance of V1CommonMetricValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CommonMetricValue.parse_obj(obj)

        _obj = V1CommonMetricValue.parse_obj({
            "value_string": obj.get("valueString"),
            "value_numeric": obj.get("valueNumeric"),
            "map_values": obj.get("mapValues")
        })
        return _obj
