...
class ClimateAPIRetrieveClimateDataAsOfDate400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClimateAPIRetrieveClimateDataAsOfDate400Response:
        """Create an instance of ClimateAPIRetrieveClimateDataAsOfDate400Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClimateAPIRetrieveClimateDataAsOfDate400Response:
        """Create an instance of ClimateAPIRetrieveClimateDataAsOfDate400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClimateAPIRetrieveClimateDataAsOfDate400Response.parse_obj(obj)

        _obj = ClimateAPIRetrieveClimateDataAsOfDate400Response.parse_obj({
            "code": obj.get("code"),
