...
import aladdinsdk.api.codegen.analytics.data.climate.v1.ClimateAPI.models
from aladdinsdk.api.codegen.analytics.data.climate.v1.ClimateAPI import rest
from aladdinsdk.api.codegen.analytics.data.climate.v1.ClimateAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.analytics.data.climate.v1.ClimateAPI.models, klass)
