...
import aladdinsdk.api.codegen.analytics.data.esg.v1.esg_data.models
from aladdinsdk.api.codegen.analytics.data.esg.v1.esg_data import rest
from aladdinsdk.api.codegen.analytics.data.esg.v1.esg_data.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.analytics.data.esg.v1.esg_data.models, klass)
