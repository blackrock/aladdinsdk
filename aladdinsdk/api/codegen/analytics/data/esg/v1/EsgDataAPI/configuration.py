...
conf = aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI.Configuration(
...
conf = aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://localhost/api/analytics/data/esg/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI")
