...
import aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI.models
from aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI import rest
from aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aladdinsdk.api.codegen.analytics.data.esg.v1.EsgDataAPI.models, klass)
