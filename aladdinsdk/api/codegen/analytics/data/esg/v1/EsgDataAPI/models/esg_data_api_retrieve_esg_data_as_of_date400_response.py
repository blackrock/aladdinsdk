...
class EsgDataAPIRetrieveEsgDataAsOfDate400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EsgDataAPIRetrieveEsgDataAsOfDate400Response:
        """Create an instance of EsgDataAPIRetrieveEsgDataAsOfDate400Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EsgDataAPIRetrieveEsgDataAsOfDate400Response:
        """Create an instance of EsgDataAPIRetrieveEsgDataAsOfDate400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EsgDataAPIRetrieveEsgDataAsOfDate400Response.parse_obj(obj)

        _obj = EsgDataAPIRetrieveEsgDataAsOfDate400Response.parse_obj({
            "code": obj.get("code"),
