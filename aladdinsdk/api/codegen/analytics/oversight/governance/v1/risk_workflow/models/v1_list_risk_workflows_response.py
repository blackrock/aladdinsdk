...
class V1ListRiskWorkflowsResponse(BaseModel):
    """
    ...
    __properties = ["workflowItems", "count", "total"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ListRiskWorkflowsResponse:
        """Create an instance of V1ListRiskWorkflowsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ListRiskWorkflowsResponse:
        """Create an instance of V1ListRiskWorkflowsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ListRiskWorkflowsResponse.parse_obj(obj)

        _obj = V1ListRiskWorkflowsResponse.parse_obj({
