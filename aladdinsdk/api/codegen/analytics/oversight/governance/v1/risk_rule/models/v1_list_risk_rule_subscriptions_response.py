...
class V1ListRiskRuleSubscriptionsResponse(BaseModel):
    """
    V1ListRiskRuleSubscriptionsResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ListRiskRuleSubscriptionsResponse:
        """Create an instance of V1ListRiskRuleSubscriptionsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ListRiskRuleSubscriptionsResponse:
        """Create an instance of V1ListRiskRuleSubscriptionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ListRiskRuleSubscriptionsResponse.parse_obj(obj)

        _obj = V1ListRiskRuleSubscriptionsResponse.parse_obj({
