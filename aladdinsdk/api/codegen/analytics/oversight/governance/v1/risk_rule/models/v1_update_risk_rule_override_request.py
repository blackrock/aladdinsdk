...
class V1UpdateRiskRuleOverrideRequest(BaseModel):
    """
    V1UpdateRiskRuleOverrideRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateRiskRuleOverrideRequest:
        """Create an instance of V1UpdateRiskRuleOverrideRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateRiskRuleOverrideRequest:
        """Create an instance of V1UpdateRiskRuleOverrideRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateRiskRuleOverrideRequest.parse_obj(obj)

        _obj = V1UpdateRiskRuleOverrideRequest.parse_obj({
