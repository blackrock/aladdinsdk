...
class V1UpdateRiskRuleOverrideResult(BaseModel):
    """
    V1UpdateRiskRuleOverrideResult
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateRiskRuleOverrideResult:
        """Create an instance of V1UpdateRiskRuleOverrideResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateRiskRuleOverrideResult:
        """Create an instance of V1UpdateRiskRuleOverrideResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateRiskRuleOverrideResult.parse_obj(obj)

        _obj = V1UpdateRiskRuleOverrideResult.parse_obj({
