...
class V1CreateRiskRuleOverrideResult(BaseModel):
    """
    V1CreateRiskRuleOverrideResult
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateRiskRuleOverrideResult:
        """Create an instance of V1CreateRiskRuleOverrideResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateRiskRuleOverrideResult:
        """Create an instance of V1CreateRiskRuleOverrideResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateRiskRuleOverrideResult.parse_obj(obj)

        _obj = V1CreateRiskRuleOverrideResult.parse_obj({
