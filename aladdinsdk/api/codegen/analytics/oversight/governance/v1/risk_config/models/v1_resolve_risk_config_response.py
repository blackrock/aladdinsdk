...
class V1ResolveRiskConfigResponse(BaseModel):
    """
    V1ResolveRiskConfigResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ResolveRiskConfigResponse:
        """Create an instance of V1ResolveRiskConfigResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ResolveRiskConfigResponse:
        """Create an instance of V1ResolveRiskConfigResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ResolveRiskConfigResponse.parse_obj(obj)

        _obj = V1ResolveRiskConfigResponse.parse_obj({
