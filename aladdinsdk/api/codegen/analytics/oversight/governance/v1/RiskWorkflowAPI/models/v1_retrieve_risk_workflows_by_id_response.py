...
class V1RetrieveRiskWorkflowsByIdResponse(BaseModel):
    """
    V1RetrieveRiskWorkflowsByIdResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1RetrieveRiskWorkflowsByIdResponse:
        """Create an instance of V1RetrieveRiskWorkflowsByIdResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1RetrieveRiskWorkflowsByIdResponse:
        """Create an instance of V1RetrieveRiskWorkflowsByIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1RetrieveRiskWorkflowsByIdResponse.parse_obj(obj)

        _obj = V1RetrieveRiskWorkflowsByIdResponse.parse_obj({
