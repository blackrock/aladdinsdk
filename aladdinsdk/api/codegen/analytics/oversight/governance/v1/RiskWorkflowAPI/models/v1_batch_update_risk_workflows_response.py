...
class V1BatchUpdateRiskWorkflowsResponse(BaseModel):
    """
    V1BatchUpdateRiskWorkflowsResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchUpdateRiskWorkflowsResponse:
        """Create an instance of V1BatchUpdateRiskWorkflowsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchUpdateRiskWorkflowsResponse:
        """Create an instance of V1BatchUpdateRiskWorkflowsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchUpdateRiskWorkflowsResponse.parse_obj(obj)

        _obj = V1BatchUpdateRiskWorkflowsResponse.parse_obj({
