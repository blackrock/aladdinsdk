...
class V1ComputePortfolioSummaryAnalyticsRequest(BaseModel):
    """
    V1ComputePortfolioSummaryAnalyticsRequest
    """
    ...
    __properties = ["portfolioTicker", "reportingDate", "reportingCurrencyCode", "benchmarkConfig", "columnConfig", "splitPositionConfig", "lookThroughConfig", "filterConfigs", "calendar", "bypassCaching"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ComputePortfolioSummaryAnalyticsRequest:
        """Create an instance of V1ComputePortfolioSummaryAnalyticsRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ComputePortfolioSummaryAnalyticsRequest:
        """Create an instance of V1ComputePortfolioSummaryAnalyticsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ComputePortfolioSummaryAnalyticsRequest.parse_obj(obj)

        _obj = V1ComputePortfolioSummaryAnalyticsRequest.parse_obj({
