...
class V1SwapLegCashFlow(BaseModel):
    """
    V1SwapLegCashFlow
    """
    ...
    __properties = ["cashflow", "balance", "principal", "interest"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SwapLegCashFlow:
        """Create an instance of V1SwapLegCashFlow from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SwapLegCashFlow:
        """Create an instance of V1SwapLegCashFlow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1SwapLegCashFlow.parse_obj(obj)

        _obj = V1SwapLegCashFlow.parse_obj({
