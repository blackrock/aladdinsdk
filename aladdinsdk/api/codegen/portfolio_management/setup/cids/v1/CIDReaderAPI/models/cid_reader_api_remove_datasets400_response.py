...
class CIDReaderAPIRemoveDatasets400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CIDReaderAPIRemoveDatasets400Response:
        """Create an instance of CIDReaderAPIRemoveDatasets400Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CIDReaderAPIRemoveDatasets400Response:
        """Create an instance of CIDReaderAPIRemoveDatasets400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CIDReaderAPIRemoveDatasets400Response.parse_obj(obj)

        _obj = CIDReaderAPIRemoveDatasets400Response.parse_obj({
            "code": obj.get("code"),
