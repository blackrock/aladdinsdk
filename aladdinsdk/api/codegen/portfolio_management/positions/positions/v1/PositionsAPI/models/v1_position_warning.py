...
class V1PositionWarning(BaseModel):
    """
    V1PositionWarning
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1PositionWarning:
        """Create an instance of V1PositionWarning from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1PositionWarning:
        """Create an instance of V1PositionWarning from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1PositionWarning.parse_obj(obj)

        _obj = V1PositionWarning.parse_obj({
