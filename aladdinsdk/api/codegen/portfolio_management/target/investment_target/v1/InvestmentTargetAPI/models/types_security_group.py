...
class TypesSecurityGroup(BaseModel):
    """
    TypesSecurityGroup
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TypesSecurityGroup:
        """Create an instance of TypesSecurityGroup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TypesSecurityGroup:
        """Create an instance of TypesSecurityGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TypesSecurityGroup.parse_obj(obj)

        _obj = TypesSecurityGroup.parse_obj({
