...
class V1BatchValidateInvestmentTargetsRequest(BaseModel):
    """
    V1BatchValidateInvestmentTargetsRequest
    """
    investment_targets: conlist(V1InvestmentTarget) = Field(..., alias="investmentTargets")
    __properties = ["investmentTargets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1BatchValidateInvestmentTargetsRequest:
        """Create an instance of V1BatchValidateInvestmentTargetsRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1BatchValidateInvestmentTargetsRequest:
        """Create an instance of V1BatchValidateInvestmentTargetsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1BatchValidateInvestmentTargetsRequest.parse_obj(obj)

        _obj = V1BatchValidateInvestmentTargetsRequest.parse_obj({
