...
class TestCommonAuthenticationOauthCredFlow(TestCase):
    ...
    def test_retrieve_token_details_refresh_token_flow_success_response(self, us_auth_proxy_mock, url, requests):
        ...
        result = self.test_subject._retrieve_token_details(client_id='id', client_secret='secret', refresh_token='token', scopes='offline_access', auth_flow_type='refresh_token')
    ...
    def test_retrieve_token_details_client_credentails_flow_success_response(self, us_auth_proxy_mock, url, requests):
        us_auth_proxy_mock.return_value = "XYZ"
        result = self.test_subject._retrieve_token_details(client_id='id', client_secret='secret', refresh_token=None, scopes='offline_access', auth_flow_type='client_credentials')
        self.assertEqual(result, ('ACCESS_TOKEN123', 3600))
    ...
    def test_retrieve_token_details_when_scopes_not_provided_success_response(self, us_auth_proxy_mock, url, requests):
        us_auth_proxy_mock.return_value = "XYZ"
        result = self.test_subject._retrieve_token_details(client_id='id', client_secret='secret', refresh_token=None, scopes=None, auth_flow_type='client_credentials')
        self.assertEqual(result, ('ACCESS_TOKEN123', 3600))
    ...
    def test_get_auth_server_response_error(self, url, requests):
        from aladdinsdk.common.error.asdkerrors import AsdkOAuthException
        with self.assertRaises(AsdkOAuthException) as context:  
            result = self.test_subject._retrieve_token_details(client_id='error', client_secret='secret', refresh_token='token', scopes='offline_access', auth_flow_type='refresh_token')
    ...
    def test_get_oauth_access_token_refresh_token_flow_success(self, url, requests):
        result = self.test_subject.get_access_token_and_ttl_from_oauth_server(client_id='id', client_secret='secret', refresh_token='token', scopes='offline_access', auth_flow_type='refresh_token')
    ...
    def test_get_auth_server_request_error(self, requests):
        resp = self.test_subject.get_access_token_and_ttl_from_oauth_server(client_id='id', client_secret='secret', refresh_token='token', scopes='offline_access', auth_flow_type='refresh_token')
    ...
    def test_get_auth_server_request_error_client_creds_missing_client_details(self, mock_logger_debug):
        ...
        resp = oauth_token_cred_client.get_access_token_and_ttl_from_oauth_server(client_id=None, client_secret=None, refresh_token=None, scopes='offline_access', auth_flow_type='client_credentials')
        self.assertEqual(resp, (None, None))
    ...
    def test_get_auth_server_request_error_refresh_token_missing_details(self, mock_logger_debug):
        from aladdinsdk.common.authentication.oauth import oauth_token_cred_client        
        oauth_token_cred_client.SDK_HELP_MESSAGE_SUFFIX = "Please check README.md for more information"
        resp = oauth_token_cred_client.get_access_token_and_ttl_from_oauth_server(client_id=None, client_secret=None, refresh_token=None, scopes='offline_access', auth_flow_type='refresh_token')
        self.assertEqual(resp, (None, None))
        mock_logger_debug.assert_called()
    ...
    def test_get_auth_server_request_error_refresh_token_missing_refresh_tokens(self, mock_logger_debug):
        from aladdinsdk.common.authentication.oauth import oauth_token_cred_client
        oauth_token_cred_client.SDK_HELP_MESSAGE_SUFFIX = "Please check README.md for more information"
        resp = oauth_token_cred_client.get_access_token_and_ttl_from_oauth_server(client_id="SOMEVAL", client_secret="SOMESECRET", refresh_token="<no value>", scopes='offline_access', auth_flow_type='refresh_token')
        self.assertEqual(resp, (None, None))
        mock_logger_debug.assert_called()
    ...
    @mock.patch('aladdinsdk.common.authentication.oauth.oauth_token_cred_client.user_settings.get_api_oauth_auth_server_proxy', return_value="https://test-proxy")
