...
import pandas as pd
from aladdinsdk.common.error.asdkerrors import AsdkApiException, AsdkEmailNotificationException, AsdkExportDataException, AsdkSetupException
from aladdinsdk.common.error.handlers.abstract import exception_type_matches, AbstractAsdkExceptionHandler
...
class TestCommonErrorHandlerUtils(TestCase):
    ...
    def test_exception_type_match_from_lists(self):
        ...
        test_supported_list_success_2 = ["aladdinsdk.common.error.asdkerrors.AsdkApiException", "aladdinsdk.common.error.asdkerrors.AsdkSetupException", "aladdinsdk.common.error.asdkerrors.AsdkExportDataException"]
    ...
    def test_register_handler_class_failure(self):
        ...
        with self.assertRaises(AsdkSetupException) as context:
            ...
            self.assertEqual("Unable to register provided exception handler. Must be an implementation of AbstractAsdkExceptionHandler.", context.exception)
    ...
    def test_api_handle_error(self):
        ...
        with mock.patch.object(test_subject.instance, 'train_journey_api_filter_train_journeys') as mock_filter_call:
            ...
            with self.assertRaises(UnauthorizedException) as context:
                resp = test_subject.call_api('train_journey_api_filter_train_journeys', { "payload_key": "payload value" })
                self.assertTrue("Mock UnauthorizedException" in context.exception)
...
class TestCommonErrorHandlerEmailNotifications(TestCase):
    ...
    def test_export_data_handle_error(self):
        ...
        test_subject = email_notifications_for_errors
