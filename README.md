...
| API: <br/>&nbsp;&nbsp; LRO: <br/>&nbsp;&nbsp;&nbsp;&nbsp; RETRY: <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MAX_ATTEMPTS:          | Maximum number of retry attempts for LRO creation on retryable HTTP errors. <br /> Can be overridden using `_max_retries` parameter for call_lro_api method. <br /> (ASDK_API__LRO__RETRY__MAX_ATTEMPTS)                                                                                                   |                      3                      |                             -                              |
| API: <br/>&nbsp;&nbsp; LRO: <br/>&nbsp;&nbsp;&nbsp;&nbsp; RETRY: <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; INITIAL_BACKOFF:       | Initial backoff time in seconds for LRO creation retries. Wait time increases linearly per attempt (e.g. 10s, 20s, 30s). <br /> Can be overridden using `_initial_backoff` parameter for call_lro_api method. <br /> (ASDK_API__LRO__RETRY__INITIAL_BACKOFF)                                                |               10 (seconds)                  |                             -                              |
| API: <br/>&nbsp;&nbsp; LRO: <br/>&nbsp;&nbsp;&nbsp;&nbsp; RETRY: <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; RETRYABLE_STATUS_CODES:| List of HTTP status codes that trigger a retry for LRO creation. <br /> Can be overridden using `_retryable_status_codes` parameter for call_lro_api method. <br /> (ASDK_API__LRO__RETRY__RETRYABLE_STATUS_CODES)                                                                                          |          `[429, 500, 502, 503, 504]`             |                        List of int                         |
...
| API: <br/>&nbsp;&nbsp; RATE_LIMITING: <br/>&nbsp;&nbsp;&nbsp;&nbsp; ENABLED:                                                      | Global toggle to enable or disable rate limiting for all API calls. <br /> (ASDK_API__RATE_LIMITING__ENABLED)                                                                                                                                                                                              |                   `true`                    |                      `true` / `false`                      |
| API: <br/>&nbsp;&nbsp; RATE_LIMITING: <br/>&nbsp;&nbsp;&nbsp;&nbsp; OVERRIDES:                                                    | Per-API and per-endpoint rate limit configuration. Each API entry can set `enabled` (bool) and `endpoints` (dict). <br /> Each endpoint entry accepts `enabled` (bool), `max_calls` (int), and `window_seconds` (int). <br /> (ASDK_API__RATE_LIMITING__OVERRIDES)                                        |                    `{}`                     |                       See docs                             |
...
| Configuration Key                                                                                                                 | Description <br /> (Override environment variable)                                                                                                                                                                                                                                                         |                   Default                   |                      Permitted Values                      |
|:----------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------:|:----------------------------------------------------------:|
| STORAGE: <br/>&nbsp;&nbsp; S3: <br/>&nbsp;&nbsp;&nbsp;&nbsp; ENDPOINT_URL                                                         | The URL to use for Storage S3 workspace.                                                                                                                                                                                                                                                                   |    _ALE_S3_ENDPOINT files.dat value at client_     |                             -                              |
